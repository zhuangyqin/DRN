...
CocoToVoc = np.zeros((255))
CocoToVoc[0] = 0
CocoToVoc[5] = 1  #airplane
CocoToVoc[2] = 2  #bicycle
CocoToVoc[15] = 3 #bird
CocoToVoc[9] = 4  #boat
CocoToVoc[40] = 5   #bottle
CocoToVoc[6] = 6   #bus
CocoToVoc[3] = 7   #car
CocoToVoc[16] = 8   #cat
CocoToVoc[57] = 9   #chair
CocoToVoc[20] = 10  #cow
CocoToVoc[61] = 11  #diningtable
CocoToVoc[17] = 12  #dog
CocoToVoc[18] = 13  #horse
CocoToVoc[4] = 14   #motorbike
CocoToVoc[1] = 15   #person
CocoToVoc[59] = 16   #pottedplant
CocoToVoc[19] = 17    #sheep
CocoToVoc[58] = 18    #sofa
CocoToVoc[7] = 19   #traincd
CocoToVoc[63] = 20   #tvmonitor
...
def cocoSegmentationToSegmentationMap(coco, imgId, checkUniquePixelLabel=False, includeCrowd=False):
    ...
    for a in xrange(0, len(imgAnnots)):
        ...
        newLabel = CocoToVoc[imgAnnots[a]['category_id']]
