...
class IMDB(object):
    ...
    def get_flipped_entry(self, seg_rec):
        label_2_id=seg_rec.get('label_2_id',None)
    ...
    def append_flipped_images_for_segmentation(self, segdb,use_pool=True):
        """
        ...
        for i in range(self.num_images):
            ...
            if use_pool:
                ...
                segdb_flip.append(get_flipped_entry_outclass_wrapper(self, seg_rec,))
