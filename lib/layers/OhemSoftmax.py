...
class OhemSoftmax(mx.operator.CustomOp):
    ...
    def forward(self, is_train, req, in_data, out_data, aux):
        ...
        # x shape [num_classes,batch_size,imh,imw] to shape [numclass,num of label]
    ...
    def backward(self, req, out_grad, in_data, out_data, in_grad, aux):
        ...
        if self._min_kept >= num_valid:
            logging.info('ohem_softmax Labels: {}'.format(num_valid))
        elif num_valid > 0:
            ...
            if self._margin > 0:
                ...
                valid_inds = valid_inds[kept_flag]
                label = label[kept_flag]
            logging.info('ohem_softmax Labels: {} {} {}'.format(len(label), threshold, margin_threshold))
