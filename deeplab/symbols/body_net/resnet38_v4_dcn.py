...
@file: resnet38_v2_dcn.py
@time: 2017/9/28 14:12
"""
import mxnet as mx
...
def get_conv_feature(data,is_train=True,workspace=2048,fix_gamma=True,use_global_stats=True,eps =1.001e-5):
    ...
    res6a_branch2b_offset_weight = mx.symbol.Variable('res6a_branch2b_offset_weight', lr_mult=1.0)
    res6a_branch2b_offset_bias = mx.symbol.Variable('res6a_branch2b_offset_bias', lr_mult=2.0)
    res6a_branch2b_offset = mx.symbol.Convolution(name='res6a_branch2b_offset', data=res6a_branch2b1_relu,
                                                  num_filter=18, pad=(1, 1), kernel=(3, 3), stride=(1, 1),
                                                  weight=res6a_branch2b_offset_weight,
                                                  bias=res6a_branch2b_offset_bias)

    res6a_branch2b1 = mx.contrib.symbol.DeformableConvolution(name='res6a_branch2b1', data=res6a_branch2b1_relu,
                                                              offset=res6a_branch2b_offset,
    ...
    res7a_branch2b_offset_weight = mx.symbol.Variable('res7a_branch2b_offset_weight', lr_mult=1.0)
    res7a_branch2b_offset_bias = mx.symbol.Variable('res7a_branch2b_offset_bias', lr_mult=2.0)
    res7a_branch2b_offset = mx.symbol.Convolution(name='res7a_branch2b_offset', data=res7a_branch2b1_relu,
                                                  num_filter=18, pad=(1, 1), kernel=(3, 3), stride=(1, 1),
                                                  weight=res7a_branch2b_offset_weight,
                                                  bias=res7a_branch2b_offset_bias)

    res7a_branch2b1 = mx.contrib.symbol.DeformableConvolution(name='res7a_branch2b1', data=res7a_branch2b1_relu,
                                                              offset=res7a_branch2b_offset,
