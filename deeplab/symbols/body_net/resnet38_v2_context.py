...
def get_conv_feature(data,rois,crop_feature_size,is_train=True,workspace=2048,fix_gamma=True,use_global_stats=True,eps =1.001e-5):
    ...
    res2a_out = mx.sym.ROIPooling(res2a_out, rois, crop_feature_size, spatial_scale=0.5)
