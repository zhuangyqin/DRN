...
def get_share_feature(data,origin_data,is_train=True,workspace=2048,fix_gamma=True,use_global_stats=True,eps =1.001e-5):
    ...
    return res3b2_out,  context_res3b2_out
...
def get_context_feature(in_data,is_train=True,workspace=2048,fix_gamma=True,use_global_stats=True,eps =1.001e-5):
    ...
    bn4a_branch2a = mx.symbol.BatchNorm(name="context_bn4a_branch2a", data=in_data, beta=bn4a_branch2a_beta,
                                        fix_gamma=fix_gamma,
                                        use_global_stats=use_global_stats, eps=eps)

    res4a_branch2a_relu = mx.symbol.Activation(name="context_res4a_branch2a_relu", data=bn4a_branch2a, act_type='relu')

    res4a_branch1 = mx.symbol.Convolution(name="context_res4a_branch1", data=res4a_branch2a_relu, dilate=(1, 1),
                                          kernel=(1, 1),
                                          no_bias=True,
                                          num_filter=512,
                                          num_group=1, pad=(0, 0), stride=(2, 2), workspace=workspace)
    ...
    bn4a_branch2b1 = mx.symbol.BatchNorm(name="context_bn4a_branch2b1", data=res4a_branch2a, beta=bn4a_branch2b1_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res4a_branch2b1_relu = mx.symbol.Activation(name="context_res4a_branch2b1_relu", data=bn4a_branch2b1,
                                                act_type='relu')
    ...
    bn4b1_branch2a = mx.symbol.BatchNorm(name="context_bn4b1_branch2a", data=res4a_out, beta=bn4b1_branch2a_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res4b1_branch2a_relu = mx.symbol.Activation(name="context_res4b1_branch2a_relu", data=bn4b1_branch2a,
                                                act_type='relu')
    ...
    bn4b1_branch2b1 = mx.symbol.BatchNorm(name="context_bn4b1_branch2b1", data=res4b1_branch2a,
                                          beta=bn4b1_branch2b1_beta,
                                          fix_gamma=fix_gamma,
                                          use_global_stats=use_global_stats, eps=eps)

    res4b1_branch2b1_relu = mx.symbol.Activation(name="context_res4b1_branch2b1_relu", data=bn4b1_branch2b1,
                                                 act_type='relu')
    ...
    bn4b2_branch2a = mx.symbol.BatchNorm(name="context_bn4b2_branch2a", data=res4b1_out, beta=bn4b2_branch2a_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res4b2_branch2a_relu = mx.symbol.Activation(name="context_res4b2_branch2a_relu", data=bn4b2_branch2a,
                                                act_type='relu')
    ...
    bn4b2_branch2b1 = mx.symbol.BatchNorm(name="context_bn4b2_branch2b1", beta=bn4b2_branch2b1_beta,
                                          data=res4b2_branch2a,
                                          fix_gamma=fix_gamma,
                                          use_global_stats=use_global_stats, eps=eps)

    res4b2_branch2b1_relu = mx.symbol.Activation(name="context_res4b2_branch2b1_relu", data=bn4b2_branch2b1,
                                                 act_type='relu')
    ...
    bn4b3_branch2a = mx.symbol.BatchNorm(name="context_bn4b3_branch2a", data=res4b2_out, beta=bn4b3_branch2a_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res4b3_branch2a_relu = mx.symbol.Activation(name="context_res4b3_branch2a_relu", data=bn4b3_branch2a,
                                                act_type='relu')
    ...
    bn4b3_branch2b1 = mx.symbol.BatchNorm(name="context_bn4b3_branch2b1", data=res4b3_branch2a,
                                          beta=bn4b3_branch2b1_beta,
                                          fix_gamma=fix_gamma,
                                          use_global_stats=use_global_stats, eps=eps)

    res4b3_branch2b1_relu = mx.symbol.Activation(name="context_res4b3_branch2b1_relu", data=bn4b3_branch2b1,
                                                 act_type='relu')
    ...
    bn4b4_branch2a = mx.symbol.BatchNorm(name="context_bn4b4_branch2a", data=res4b3_out, beta=bn4b4_branch2a_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res4b4_branch2a_relu = mx.symbol.Activation(name="context_res4b4_branch2a_relu", data=bn4b4_branch2a,
                                                act_type='relu')
    ...
    bn4b4_branch2b1 = mx.symbol.BatchNorm(name="context_bn4b4_branch2b1", data=res4b4_branch2a,
    ...
    res4b5_branch2a_relu = mx.symbol.Activation(name="context_res4b5_branch2a_relu", data=bn4b5_branch2a,
                                                act_type='relu')
    ...
    bn4b5_branch2b1 = mx.symbol.BatchNorm(name="context_bn4b5_branch2b1", data=res4b5_branch2a,
    ...
    bn4_beta = mx.symbol.Variable(name="bn4_beta", lr_mult=2.0, wd_mult=0.0)
    bn4 = mx.symbol.BatchNorm(name="bn4", data=res4b5_out, beta=bn4_beta, fix_gamma=fix_gamma,
                              use_global_stats=use_global_stats, eps=eps)

    relu4 = mx.symbol.Activation(name="relu4", data=bn4, act_type='relu')
...
def get_conv_feature(in_data, is_train=True, workspace=2048, fix_gamma=True, use_global_stats=True, eps=1.001e-5):
    ...
    bn4a_branch2a = mx.symbol.BatchNorm(name="bn4a_branch2a", data=in_data, beta=bn4a_branch2a_beta,
                                        fix_gamma=fix_gamma,
                                        use_global_stats=use_global_stats, eps=eps)
...
def get_feature(data,origin_data,is_train=True, workspace=2048, fix_gamma=True, use_global_stats=True, eps=1.001e-5):
    ...
    local_feature,global_feature = get_share_feature(data,origin_data,is_train, workspace, fix_gamma, use_global_stats, eps)

    local_feature = get_conv_feature(local_feature, is_train, workspace, fix_gamma, use_global_stats, eps)

    global_feature = get_context_feature(global_feature, is_train, workspace, fix_gamma, use_global_stats, eps)
