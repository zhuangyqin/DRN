...
def get_context_feature(data,is_train=True,workspace=2048,fix_gamma=True,use_global_stats=True,eps =1.001e-5):
    
    conv1a = mx.symbol.Convolution(name='context_conv1a', data=data, num_filter=64, pad=(1, 1), kernel=(3, 3), stride=(1, 1),
                                   no_bias=True, workspace=workspace)

    # res2a for downsampling
    bn2a_branch2a_beta = mx.symbol.Variable(name="context_bn2a_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn2a_branch2a = mx.symbol.BatchNorm(name="context_bn2a_branch2a", data=conv1a, beta=bn2a_branch2a_beta,
                                        fix_gamma=fix_gamma, use_global_stats=use_global_stats, eps=eps)
    res2a_branch2a_relu = mx.symbol.Activation(name="context_res2a_branch2a_relu", data=bn2a_branch2a, act_type='relu')

    res2a_branch2a = mx.symbol.Convolution(name="context_res2a_branch2a", data=res2a_branch2a_relu, dilate=(1, 1),
                                           kernel=(3, 3),
                                           no_bias=True, num_filter=128, num_group=1, pad=(1, 1), stride=(2, 2),
                                           workspace=workspace)

    res2a_branch1 = mx.symbol.Convolution(name="context_res2a_branch1", data=res2a_branch2a_relu, dilate=(1, 1), kernel=(1, 1),
                                          no_bias=True,
                                          num_filter=128, num_group=1, pad=(0, 0), stride=(2, 2),
                                          workspace=workspace)

    bn2a_branch2b1_beta = mx.symbol.Variable(name="context_bn2a_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn2a_branch2b1 = mx.symbol.BatchNorm(name="context_bn2a_branch2b1", beta=bn2a_branch2b1_beta, data=res2a_branch2a,
                                         fix_gamma=fix_gamma, use_global_stats=use_global_stats
                                         , eps=eps)

    res2a_branch2b1_relu = mx.symbol.Activation(name="context_res2a_branch2b1_relu", data=bn2a_branch2b1, act_type='relu')

    res2a_branch2b1 = mx.symbol.Convolution(name="context_res2a_branch2b1", data=res2a_branch2b1_relu, dilate=(1, 1),
                                            kernel=(3, 3),
    ...
    # res2b1
    bn2b1_branch2a_beta = mx.symbol.Variable(name="context_bn2b1_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn2b1_branch2a = mx.symbol.BatchNorm(name="context_bn2b1_branch2a", data=res2a_out, beta=bn2b1_branch2a_beta,
                                         fix_gamma=fix_gamma, use_global_stats=use_global_stats
                                         , eps=eps)
    res2b1_branch2a_relu = mx.symbol.Activation(name="context_res2b1_branch2a_relu", data=bn2b1_branch2a, act_type='relu')

    res2b1_branch2a = mx.symbol.Convolution(name="context_res2b1_branch2a", data=res2b1_branch2a_relu, dilate=(1, 1),
                                            kernel=(3, 3), no_bias=True,
                                            num_filter=128, num_group=1, pad=(1, 1),
                                            stride=(1, 1), workspace=workspace)

    bn2b1_branch2b1_beta = mx.symbol.Variable(name="context_bn2b1_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn2b1_branch2b1 = mx.symbol.BatchNorm(name="context_bn2b1_branch2b1", beta=bn2b1_branch2b1_beta, data=res2b1_branch2a,
                                          fix_gamma=fix_gamma,
                                          use_global_stats=use_global_stats, eps=eps)

    res2b1_branch2b1_relu = mx.symbol.Activation(name="context_res2b1_branch2b1_relu", data=bn2b1_branch2b1, act_type='relu')

    res2b1_branch2b1 = mx.symbol.Convolution(name="context_res2b1_branch2b1", data=res2b1_branch2b1_relu, dilate=(1, 1),
                                             kernel=(3, 3), no_bias=True,
                                             num_filter=128, num_group=1, pad=(1, 1),
                                             stride=(1, 1), workspace=workspace)
    ...
    bn2b2_branch2a_beta = mx.symbol.Variable(name="context_bn2b2_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn2b2_branch2a = mx.symbol.BatchNorm(name="context_bn2b2_branch2a", data=res2a_plus2, beta=bn2b2_branch2a_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res2b2_branch2a_relu = mx.symbol.Activation(name="context_res2b2_branch2a_relu", data=bn2b2_branch2a, act_type='relu')

    res2b2_branch2a = mx.symbol.Convolution(name="context_res2b2_branch2a", data=res2b2_branch2a_relu, dilate=(1, 1),
                                            kernel=(3, 3), no_bias=True,
                                            num_filter=128, num_group=1, pad=(1, 1),
                                            stride=(1, 1), workspace=workspace)

    bn2b2_branch2b1_beta = mx.symbol.Variable(name="context_bn2b2_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn2b2_branch2b1 = mx.symbol.BatchNorm(name="context_bn2b2_branch2b1", data=res2b2_branch2a, beta=bn2b2_branch2b1_beta,
                                          fix_gamma=fix_gamma, use_global_stats=use_global_stats,
                                          eps=eps)

    res2b2_branch2b1_relu = mx.symbol.Activation(name="context_res2b2_branch2b1_relu", data=bn2b2_branch2b1, act_type='relu')

    res2b2_branch2b1 = mx.symbol.Convolution(name="context_res2b2_branch2b1", data=res2b2_branch2b1_relu, dilate=(1, 1),
                                             kernel=(3, 3), no_bias=True,
                                             num_filter=128, num_group=1, pad=(1, 1),
                                             stride=(1, 1), workspace=workspace)
    ...
    bn3a_branch2a_beta = mx.symbol.Variable(name="context_bn3a_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn3a_branch2a = mx.symbol.BatchNorm(name="context_bn3a_branch2a", data=res2a_plus3, beta=bn3a_branch2a_beta,
                                        fix_gamma=fix_gamma, use_global_stats=use_global_stats, eps=eps)

    res3a_branch2a_relu = mx.symbol.Activation(name="context_res3a_branch2a_relu", data=bn3a_branch2a, act_type='relu')

    res3a_branch1 = mx.symbol.Convolution(name="context_res3a_branch1", data=res3a_branch2a_relu, dilate=(1, 1), kernel=(1, 1),
                                          no_bias=True, num_filter=256,
                                          num_group=1, pad=(0, 0), stride=(2, 2), workspace=workspace)

    res3a_branch2a = mx.symbol.Convolution(name="context_res3a_branch2a", data=res3a_branch2a_relu, dilate=(1, 1),
                                           kernel=(3, 3), no_bias=True, num_filter=256,
                                           num_group=1, pad=(1, 1), stride=(2, 2), workspace=workspace)

    bn3a_branch2b1_beta = mx.symbol.Variable(name="context_bn3a_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn3a_branch2b1 = mx.symbol.BatchNorm(name="context_bn3a_branch2b1", data=res3a_branch2a, beta=bn3a_branch2b1_beta,
                                         fix_gamma=fix_gamma, use_global_stats=use_global_stats, eps=eps)
    res3a_branch2b1_relu = mx.symbol.Activation(name="context_res3a_branch2b1_relu", data=bn3a_branch2b1, act_type='relu')
    res3a_branch2b1 = mx.symbol.Convolution(name="context_res3a_branch2b1", data=res3a_branch2b1_relu, dilate=(1, 1),
                                            kernel=(3, 3), no_bias=True, num_filter=256,
    ...
    ##res3a b1
    bn3b1_branch2a_beta = mx.symbol.Variable(name="context_bn3b1_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn3b1_branch2a = mx.symbol.BatchNorm(name="context_bn3b1_branch2a", data=res3a_out, beta=bn3b1_branch2a_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res3b1_branch2a_relu = mx.symbol.Activation(name="context_res3b1_branch2a_relu", data=bn3b1_branch2a, act_type='relu')

    res3b1_branch2a = mx.symbol.Convolution(name="context_res3b1_branch2a", data=res3b1_branch2a_relu, dilate=(1, 1),
                                            kernel=(3, 3), no_bias=True, num_filter=256,
                                            num_group=1, pad=(1, 1), stride=(1, 1), workspace=workspace)

    bn3b1_branch2b1_beta = mx.symbol.Variable(name="context_bn3b1_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn3b1_branch2b1 = mx.symbol.BatchNorm(name="context_bn3b1_branch2b1", data=res3b1_branch2a, beta=bn3b1_branch2b1_beta,
                                          fix_gamma=fix_gamma,
                                          use_global_stats=use_global_stats, eps=eps)

    res3b1_branch2b1_relu = mx.symbol.Activation(name="context_res3b1_branch2b1_relu", data=bn3b1_branch2b1, act_type='relu')

    res3b1_branch2b1 = mx.symbol.Convolution(name="context_res3b1_branch2b1", data=res3b1_branch2b1_relu, dilate=(1, 1),
                                             kernel=(3, 3), no_bias=True, num_filter=256,
                                             num_group=1, pad=(1, 1), stride=(1, 1), workspace=workspace)
    ...
    ##res3a b2
    bn3b2_branch2a_beta = mx.symbol.Variable(name="context_bn3b2_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn3b2_branch2a = mx.symbol.BatchNorm(name="context_bn3b2_branch2a", beta=bn3b2_branch2a_beta, data=res3b1_out,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res3b2_branch2a_relu = mx.symbol.Activation(data=bn3b2_branch2a, name="context_res3b2_branch2a_relu",
                                                act_type='relu')
    res3b2_branch2a = mx.symbol.Convolution(name="context_res3b2_branch2a", data=res3b2_branch2a_relu, dilate=(1, 1),
                                            kernel=(3, 3), no_bias=True, num_filter=256,
                                            num_group=1, pad=(1, 1), stride=(1, 1), workspace=workspace)

    bn3b2_branch2b1_beta = mx.symbol.Variable(name="context_bn3b2_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn3b2_branch2b1 = mx.symbol.BatchNorm(name="context_bn3b2_branch2b1", data=res3b2_branch2a, beta=bn3b2_branch2b1_beta,
                                          fix_gamma=fix_gamma,
                                          use_global_stats=use_global_stats, eps=eps)

    res3b2_branch2b1_relu = mx.symbol.Activation(name="context_res3b2_branch2b1_relu", data=bn3b2_branch2b1, act_type='relu')

    res3b2_branch2b1 = mx.symbol.Convolution(name="context_res3b2_branch2b1", data=res3b2_branch2b1_relu, dilate=(1, 1),
                                             kernel=(3, 3), no_bias=True, num_filter=256,
                                             num_group=1, pad=(1, 1), stride=(1, 1), workspace=workspace)
    ...
    bn4a_branch2a_beta = mx.symbol.Variable(name="context_bn4a_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn4a_branch2a = mx.symbol.BatchNorm(name="context_bn4a_branch2a", data=res3b2_out, beta=bn4a_branch2a_beta,
                                        fix_gamma=fix_gamma,
                                        use_global_stats=use_global_stats, eps=eps)

    res4a_branch2a_relu = mx.symbol.Activation(name="context_res4a_branch2a_relu", data=bn4a_branch2a, act_type='relu')

    res4a_branch1 = mx.symbol.Convolution(name="context_res4a_branch1", data=res4a_branch2a_relu, dilate=(1, 1), kernel=(1, 1),
                                          no_bias=True,
                                          num_filter=512,
                                          num_group=1, pad=(0, 0), stride=(2, 2), workspace=workspace)

    res4a_branch2a = mx.symbol.Convolution(name="context_res4a_branch2a", data=res4a_branch2a_relu, dilate=(1, 1),
                                           kernel=(3, 3), no_bias=True,
                                           num_filter=512,
                                           num_group=1, pad=(1, 1), stride=(2, 2), workspace=workspace)

    bn4a_branch2b1_beta = mx.symbol.Variable(name="context_bn4a_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn4a_branch2b1 = mx.symbol.BatchNorm(name="context_bn4a_branch2b1", data=res4a_branch2a, beta=bn4a_branch2b1_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res4a_branch2b1_relu = mx.symbol.Activation(name="context_res4a_branch2b1_relu", data=bn4a_branch2b1, act_type='relu')

    res4a_branch2b1 = mx.symbol.Convolution(name="context_res4a_branch2b1", data=res4a_branch2b1_relu, dilate=(1, 1),
                                            kernel=(3, 3), no_bias=True,
                                            num_filter=512,
                                            num_group=1, pad=(1, 1), stride=(1, 1), workspace=workspace)
    ...
    ##res4a b1
    bn4b1_branch2a_beta = mx.symbol.Variable(name="context_bn4b1_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn4b1_branch2a = mx.symbol.BatchNorm(name="context_bn4b1_branch2a", data=res4a_out, beta=bn4b1_branch2a_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res4b1_branch2a_relu = mx.symbol.Activation(name="context_res4b1_branch2a_relu", data=bn4b1_branch2a, act_type='relu')

    res4b1_branch2a = mx.symbol.Convolution(name="context_res4b1_branch2a", data=res4b1_branch2a_relu, dilate=(1, 1),
                                            kernel=(3, 3), no_bias=True,
                                            num_filter=512, num_group=1, pad=(1, 1), stride=(1, 1),
                                            workspace=workspace)

    bn4b1_branch2b1_beta = mx.symbol.Variable(name="context_bn4b1_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn4b1_branch2b1 = mx.symbol.BatchNorm(name="context_bn4b1_branch2b1", data=res4b1_branch2a, beta=bn4b1_branch2b1_beta,
                                          fix_gamma=fix_gamma,
                                          use_global_stats=use_global_stats, eps=eps)

    res4b1_branch2b1_relu = mx.symbol.Activation(name="context_res4b1_branch2b1_relu", data=bn4b1_branch2b1, act_type='relu')

    res4b1_branch2b1 = mx.symbol.Convolution(name="context_res4b1_branch2b1", data=res4b1_branch2b1_relu, dilate=(1, 1),
                                             kernel=(3, 3), no_bias=True,
                                             num_filter=512, num_group=1, pad=(1, 1), stride=(1, 1),
                                             workspace=workspace)
    ...
    ##res4a b2
    bn4b2_branch2a_beta = mx.symbol.Variable(name="context_bn4b2_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn4b2_branch2a = mx.symbol.BatchNorm(name="context_bn4b2_branch2a", data=res4b1_out, beta=bn4b2_branch2a_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res4b2_branch2a_relu = mx.symbol.Activation(name="context_res4b2_branch2a_relu", data=bn4b2_branch2a, act_type='relu')

    res4b2_branch2a = mx.symbol.Convolution(name="context_res4b2_branch2a", data=res4b2_branch2a_relu, dilate=(1, 1),
                                            kernel=(3, 3), no_bias=True,
                                            num_filter=512, num_group=1, pad=(1, 1), stride=(1, 1),
                                            workspace=workspace)

    bn4b2_branch2b1_beta = mx.symbol.Variable(name="context_bn4b2_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn4b2_branch2b1 = mx.symbol.BatchNorm(name="context_bn4b2_branch2b1", beta=bn4b2_branch2b1_beta, data=res4b2_branch2a,
                                          fix_gamma=fix_gamma,
                                          use_global_stats=use_global_stats, eps=eps)

    res4b2_branch2b1_relu = mx.symbol.Activation(name="context_res4b2_branch2b1_relu", data=bn4b2_branch2b1, act_type='relu')

    res4b2_branch2b1 = mx.symbol.Convolution(name="context_res4b2_branch2b1", data=res4b2_branch2b1_relu, dilate=(1, 1),
                                             kernel=(3, 3), no_bias=True,
                                             num_filter=512, num_group=1, pad=(1, 1), stride=(1, 1),
                                             workspace=workspace)
    ...
    ##res4a b3
    bn4b3_branch2a_beta = mx.symbol.Variable(name="context_bn4b3_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn4b3_branch2a = mx.symbol.BatchNorm(name="context_bn4b3_branch2a", data=res4b2_out, beta=bn4b3_branch2a_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res4b3_branch2a_relu = mx.symbol.Activation(name="context_res4b3_branch2a_relu", data=bn4b3_branch2a, act_type='relu')

    res4b3_branch2a = mx.symbol.Convolution(name="context_res4b3_branch2a", data=res4b3_branch2a_relu, dilate=(1, 1),
                                            kernel=(3, 3), no_bias=True,
                                            num_filter=512, num_group=1, pad=(1, 1), stride=(1, 1),
                                            workspace=workspace)

    bn4b3_branch2b1_beta = mx.symbol.Variable(name="context_bn4b3_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn4b3_branch2b1 = mx.symbol.BatchNorm(name="context_bn4b3_branch2b1", data=res4b3_branch2a, beta=bn4b3_branch2b1_beta,
                                          fix_gamma=fix_gamma,
                                          use_global_stats=use_global_stats, eps=eps)

    res4b3_branch2b1_relu = mx.symbol.Activation(name="context_res4b3_branch2b1_relu", data=bn4b3_branch2b1, act_type='relu')

    res4b3_branch2b1 = mx.symbol.Convolution(name="context_res4b3_branch2b1", data=res4b3_branch2b1_relu, dilate=(1, 1),
                                             kernel=(3, 3), no_bias=True,
                                             num_filter=512, num_group=1, pad=(1, 1), stride=(1, 1),
                                             workspace=workspace)
    ...
    ##res4a b4
    bn4b4_branch2a_beta = mx.symbol.Variable(name="context_bn4b4_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn4b4_branch2a = mx.symbol.BatchNorm(name="context_bn4b4_branch2a", data=res4b3_out, beta=bn4b4_branch2a_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)
    res4b4_branch2a_relu = mx.symbol.Activation(name="context_res4b4_branch2a_relu", data=bn4b4_branch2a, act_type='relu')

    res4b4_branch2a = mx.symbol.Convolution(name="context_res4b4_branch2a", data=res4b4_branch2a_relu, dilate=(1, 1),
                                            kernel=(3, 3), no_bias=True,
                                            num_filter=512, num_group=1, pad=(1, 1), stride=(1, 1),
                                            workspace=workspace)
    bn4b4_branch2b1_beta = mx.symbol.Variable(name="context_bn4b4_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn4b4_branch2b1 = mx.symbol.BatchNorm(name="context_bn4b4_branch2b1", data=res4b4_branch2a, beta=bn4b4_branch2b1_beta,
                                          fix_gamma=fix_gamma,
                                          use_global_stats=use_global_stats, eps=eps)

    res4b4_branch2b1_relu = mx.symbol.Activation(name="context_res4b4_branch2b1_relu", data=bn4b4_branch2b1,
                                                 act_type='relu')

    res4b4_branch2b1 = mx.symbol.Convolution(name="context_res4b4_branch2b1", data=res4b4_branch2b1_relu, dilate=(1, 1),
                                             kernel=(3, 3), no_bias=True,
                                             num_filter=512, num_group=1, pad=(1, 1), stride=(1, 1),
                                             workspace=workspace)
    ...
    ##res4a b5
    bn4b5_branch2a_beta = mx.symbol.Variable(name="context_bn4b5_branch2a_beta", lr_mult=2.0, wd_mult=0.0)
    bn4b5_branch2a = mx.symbol.BatchNorm(name="context_bn4b5_branch2a", data=res4b4_out, beta=bn4b5_branch2a_beta,
                                         fix_gamma=fix_gamma,
                                         use_global_stats=use_global_stats, eps=eps)

    res4b5_branch2a_relu = mx.symbol.Activation(name="context_res4b5_branch2a_relu", data=bn4b5_branch2a, act_type='relu')
    res4b5_branch2a = mx.symbol.Convolution(name="context_res4b5_branch2a", data=res4b5_branch2a_relu, dilate=(1, 1),
                                            kernel=(3, 3), no_bias=True,
                                            num_filter=512, num_group=1, pad=(1, 1), stride=(1, 1),
                                            workspace=workspace)

    bn4b5_branch2b1_beta = mx.symbol.Variable(name="context_bn4b5_branch2b1_beta", lr_mult=2.0, wd_mult=0.0)
    bn4b5_branch2b1 = mx.symbol.BatchNorm(name="context_bn4b5_branch2b1", data=res4b5_branch2a, beta=bn4b5_branch2b1_beta,
                                          fix_gamma=fix_gamma,
                                          use_global_stats=use_global_stats, eps=eps)

    res4b5_branch2b1_relu = mx.symbol.Activation(name="context_res4b5_branch2b1_relu", data=bn4b5_branch2b1,
                                                 act_type='relu')

    res4b5_branch2b1 = mx.symbol.Convolution(name="context_res4b5_branch2b1", data=res4b5_branch2b1_relu, dilate=(1, 1),
                                             kernel=(3, 3), no_bias=True,
                                             num_filter=512, num_group=1, pad=(1, 1), stride=(1, 1),
                                             workspace=workspace)
    ...
    bn5a_branch2a = mx.symbol.BatchNorm(name="context_bn5a_branch2a", data=res4b5_out, beta=bn5a_branch2a_beta,
                                        fix_gamma=fix_gamma,
                                        use_global_stats=use_global_stats, eps=eps)
