...
from core.loader import TrainDataLoader,TestDataLoader
...
def train_net(args, ctx, pretrained, epoch, prefix, begin_epoch, end_epoch, lr, lr_step):
    ...
    max_label_shape = [('label', (config.TRAIN.BATCH_IMAGES, 1, max([v[0] for v in max_scale])//config.network.LABEL_STRIDE,
